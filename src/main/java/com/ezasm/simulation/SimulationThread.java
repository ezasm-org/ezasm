...
/**
 * A thread for modifying a Simulator. Used to ensure that the current thread
 * does not get blocked while executing code. Can only maintain the currently
 * running task; does not have a queue of tasks.
 */
public class SimulationThread {
    ...
    /**
     * The sleep interval to wait before doing another action. Used in the pause
     * busy-wait.
     */
    ...
    /**
     * Sets the callback function of the current thread to the given function. Only
     * activates the callback function on the termination of the next thread; no
     * subsequent threads will use this callback function.
     *
     * @param runnable the callback function to execute when the next worker thread
     *                 dies.
     */
