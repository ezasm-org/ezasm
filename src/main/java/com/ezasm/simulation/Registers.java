...
public class Registers {
     ...
     *
     * @param name
     *            the name of the register to add.
     * @param number
     *            the reference number of the register to add.
     */
     ...
     *
     * @param register
     *            the String representing the register.
     *
     ...
     *
     * @param register
     *            the number reference of to check.
     *
     * @return true if the register is valid, false otherwise.
     */
     ...
     *
     * @param register
     *            the register reference number to search.
     *
     ...
     *
     * @param register
     *            the reference number of the register to get.
     *
