...
/**
 * Represents all system registers within an array. Provides access to them by
 * name and by reference number.
 */
public class Registers {
    ...
    /**
     * Initialization function for the registers. Creates both mapping of register
    ...
    /*
     * Initializes the registers and mappings in a static context whenever this code
     * is loaded. This prevents the register mappings from ever being null.
     */
    static {
        init();
    }
    ...
    /**
     * Checks if a given String matches any of the registers. Can be the named
     * register notation or the numerical register notation to check. The register
     * attempt given should not have the '$' at the start of the String.
     *
    ...
    /**
     * Gets a register number based on the register's name or a text representation
     * of its number.
     *
