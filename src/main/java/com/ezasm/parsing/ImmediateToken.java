...
public class ImmediateToken extends RightHandToken {
    ...
    /**
     * Constructs the token based on the given text. Assumes the text has already
     * been validated to be an immediate.
     *
     * @param text the token representing the immediate value.
     */
