...
public class Lexer {
    ...
    /**
     * Parses the given text as a single line. Meant for use within a simulation of
     * the programming language.
     *
     * @param line   the line of text.
     * @param labels the mapping of label text to line numbers.
     * @param number the line number of this line.
     * @return null if the line was empty, a comment, or a label; otherwise returns
     *         the line corresponding to the text.
    ...
    /**
     * Parses a String containing multiple lines. Meant for use within a simulation
