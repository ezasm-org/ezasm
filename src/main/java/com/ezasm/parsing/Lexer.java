...
public class Lexer {
     ...
     *            the line of text.
     * @param labels
     *            the mapping of label text to line numbers.
     * @param number
     ...
     *             if the line could not be properly parsed.
     */
     ...
     *
     * @param lines
     *            the text containing the lines to parse.
     * @param labels
     *            the mapping of label text to line numbers.
     *
     ...
     *
     * @throws ParseException
     *             if any line could not be properly parsed.
     */
