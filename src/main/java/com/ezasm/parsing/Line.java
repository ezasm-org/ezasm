...
/**
 * The tokenized representation of a line. Consists of: one instruction token
 * representing the instruction, one register token representing where the
 * result of the operation will be stored, and any number of "right-hand side"
 * tokens (e.g. any tokens which can represent a value).
 */
public class Line {
     ...
     * @param storeRegister the String representing the register to store into for
     *                      this operation.
     * @param arguments     the variable sized arguments token String list.
     * @throws ParseException if any of the given String tokens cannot be parsed
