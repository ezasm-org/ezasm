...
/**
 * A representation of an instance in the command line interface. Stores the
 * current simulation and the simulation thread.
 */
public class CommandLineInterface {
    ...
    /**
     * Constructs a basic CLI based on the given Simulator. This CLI will read from
     * the terminal until the program is closed or the EOF signal is sent.
     *
    ...
    /**
     * Constructs a CLI based on the given Simulator for operating on code from a
     * file.
     *
     * @param simulator the given Simulator.
