...
public class EzCellRenderer extends CompletionCellRenderer {
    ...
    /**
     * Prepares the cell renderer for a generic completion item that is neither a variable nor a function. Sets the cell
     * icon to an empty icon, resulting in no icon being displayed for generic completions.
     *
    ...
    /**
     * Prepares the cell renderer for a variable completion item. Sets the cell icon to the variable icon (img/var.png),
     * which is displayed alongside the variable name.
     *
     * @param list     the JList displaying the completions.
    ...
    /**
     * Prepares the cell renderer for a function completion item. Sets the cell icon to the function icon
     * (img/function.png), which is displayed alongside the function name.
     *
     * @param list     the JList displaying the completions.
