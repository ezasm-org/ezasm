...
/**
 * The main graphical user interface of the program. A singleton which holds all
 * the necessary GUI components and one relevant simulator.
 */
public class Window {
    ...
    /**
     * Return the existing instance. Returns null if a simulator has not yet been
     * provided through <code>instantiate</code>.
     *
     * @return the instance.
     */
    ...
    /**
     * Gets the instance's simulation thread for use in staring the async execution
     * of the simulator's instructions.
     *
    ...
    /**
     * Handles the program completion and displays a message to the user about the
    ...
    /**
     * Enable or disable the ability of the user to edit the text pane. Text cannot
     * be selected while this is the set to false.
     *
