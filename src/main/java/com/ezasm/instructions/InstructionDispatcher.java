...
public class InstructionDispatcher {
     ...
     *
     * @param clazz
     *            The class to register instructions from.
     */
     ...
     * @param method
     *            The method to register as an instruction.
     */
     ...
     *
     * @param instruction
     *            the registered instruction to load an instance for.
     */
     ...
     *            the parsed line.
     *
     * @throws InstructionDispatchException
     *             when a parsed line cannot be interpreted as a function. This could be an
     *             {@link IllegalInstructionException} if the instruction is unrecognized, or an
     *             {@link IllegalArgumentException IllegalArgumentException} if the provided parsed arguments cannot fit
     *             to the instruction (not yet implemented).
     */
