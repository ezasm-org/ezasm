...
public class InstructionDispatcher {
    ...
    /**
     * Registers instructions from a class. Instructions are registered by scanning
     * the class's declared methods for those annotated with {@link Instruction}. It
     * enumerates the methods and scans their parameters to deduce the appropriate
     * operands.
     *
    ...
    /**
     * Registers a single instruction. The method is assumed to be annotated with
     * {@link Instruction} at this point. This function deduces the operands based
     * on the method's parameters (TODO).
     *
    ...
    /**
     * Stores instances of the classes that implement the instructions. For every
     * instantiated InstructionDispatcher, there's a set of instances that manage
     * the instructions. This allows us to bind the Simulator to the instructions.
     */
    ...
    /**
     * Create a new Instruction Dispatcher, and bind it to an existing
     * {@link Simulator}.
     *
    ...
    /**
     * Load an instance of an instruction handler for an instruction (or skip if
     * already cached).
     *
     ...
     * @throws InstructionDispatchException when a parsed line cannot be interpreted
     *                                      as a function. This could be an
     *                                      {@link IllegalInstructionException} if
     *                                      the instruction is unrecognized, or an
     *                                      {@link IllegalArgumentException
     *                                      IllegalArgumentException} if the
     *                                      provided parsed arguments cannot fit to
     *                                      the instruction (not yet implemented).
     */
