...
public class ArithmeticInstructions {
     ...
     *
     * @param input1
     *            the left-hand side of the multiply operation.
     * @param input2
     *            the right-hand side of the multiply operation.
     * @param output
     *            the output of the operation.
     */
    @Instruction
     ...
     *
     * @param input
     *            the input of the not operation.
     * @param output
     *            the output of the operation.
     */
    @Instruction
     ...
     *
     * @param input1
     *            the left-hand side of the sll operation.
     * @param input2
     *            the right-hand side of the sll operation.
     * @param output
     *            the output of the operation.
     */
    @Instruction
     ...
     *
     * @param input1
     *            the left-hand side of the srl operation.
     * @param input2
     *            the right-hand side of the srl operation.
     * @param output
     *            the output of the operation.
     */
    @Instruction
     ...
     *
     * @param output
     *            the output register of the increment.
     * @param input1
     *            the input of the increment.
     */
    @Instruction
