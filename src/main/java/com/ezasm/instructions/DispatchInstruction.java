...
public class DispatchInstruction {
     ...
     *            the method for which to deduce operands for instructions and compile into a dispatchable instruction.
     */
     ...
     *
     * @param parent
     *            the parent instruction handler. An instance of {@link DispatchInstruction#getParent()}.
     * @param line
     *            the parsed line to interpret.
     */
