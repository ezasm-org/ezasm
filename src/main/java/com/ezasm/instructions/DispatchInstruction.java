...
/**
 * An instruction which can be dispatched. This has all the information
 * necessary to interpret a parsed {@link Line} and caches it for quick
 * interpretation.
 */
public class DispatchInstruction {
    ...
    /**
     * Create a new dispatchable instruction based on a method with specific
     * parameters and its parent class.
     *
     * @param parent           the parent class.
     * @param invocationTarget the method for which to deduce operands for
     *                         instructions and compile into a dispatchable
     *                         instruction.
     */
    ...
    /**
     * Invoke an instruction based on the parsed line (interpret the arguments and
